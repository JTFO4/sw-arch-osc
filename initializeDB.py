...
c.execute('''CREATE TABLE IF NOT EXISTS ordersTable(orderId INTEGER PRIMARY KEY, userId INTEGER, items text, total REAL, date DATETIME, creditcard BIGINT, FOREIGN KEY(userId) REFERENCES usersTable(UserId))''')
